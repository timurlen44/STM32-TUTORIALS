...
void read_jn2101_node_id()
{
	...
	send_data_to_jn2101 [1] =  0x00;//LSB
	send_data_to_jn2101 [2] =  0x20;//MSB
...
{
	send_data_to_jn2101 [0] =  0x40;//Command Byte
	send_data_to_jn2101 [1] =  0x18;//LSB
	send_data_to_jn2101 [2] =  0x10;//MSB
...
{
	send_data_to_jn2101 [0] =  0x40;//Command Byte
	send_data_to_jn2101 [1] =  0x01;//LSB
	send_data_to_jn2101 [2] =  0x20;//MSB
	send_data_to_jn2101 [3] =  0x00;//Sub Index
	send_data_to_jn2101 [4] =  0x00;
	send_data_to_jn2101 [5] =  0x00;
...
{
	send_data_to_jn2101[0] = 0x40; //Command Byte
	send_data_to_jn2101[1] = 0x43; //LSB
	send_data_to_jn2101[2] = 0x20; //MSB
	send_data_to_jn2101[3] = 0x00; //Sub Index
	send_data_to_jn2101[4] = 0x00;
	send_data_to_jn2101[5] = 0x00;
...
{
	send_data_to_jn2101[0] = 0x40;  //Command Byte
	send_data_to_jn2101[1] = 0x10;  //LSB
	send_data_to_jn2101[2] = 0x60;  //MSB
	send_data_to_jn2101[3] = 0x00;  //Sub Index
	send_data_to_jn2101[4] = 0x00;
	send_data_to_jn2101[5] = 0x00;
	send_data_to_jn2101[6] = 0x00;
...
{
	send_data_to_jn2101[0] = 0x40;  //Command Byte
	send_data_to_jn2101[1] = 0x20;  //LSB
	send_data_to_jn2101[2] = 0x60;  //MSB
	send_data_to_jn2101[3] = 0x00;  //Sub Index
	send_data_to_jn2101[4] = 0x00;
	send_data_to_jn2101[5] = 0x00;
