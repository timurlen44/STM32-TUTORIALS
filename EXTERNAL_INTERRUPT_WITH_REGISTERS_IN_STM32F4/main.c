...
void GPIO_Config(void){
	RCC->AHB1ENR = 0b10001;
	GPIOE->MODER = 0x55000000;//GPIOE 12,13,14,15 OUTPUT
	GPIOE->OTYPER = 0;
	GPIOE->OSPEEDR = 0XFF000000;
	GPIOE->PUPDR = 0;
	return;
}
...
void EXTI_Config(void){
	...
	EXTI->IMR = 0X7;// PA0, PA1 VE PA2 interrupt için hazýr
	EXTI->RTSR = 0x7;// Yükselen kenarda interrupt tetiklenecek
}
/* USER CODE END PM */
